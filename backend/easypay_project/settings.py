...
GROQ_API_KEY = os.getenv('groq_api') or os.getenv('GROQ_API_KEY') or os.getenv('GROK_API_KEY')
...
CORS_ALLOW_ALL_ORIGINS = True # Set to True for debugging deployment issues
